...
def create_app(test_config: dict = None) -> Flask:
    ...
    from .routes import auth, catalogo, catalogo_publico, chamadas, chat_interno, downloads, envio_massa, followup, ligacoes, negocios, push, sistema, usuarios, whatsapp
